  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        <Link href="/vendor/products" className="p-2 hover:bg-[#F5F2ED] rounded transition text-[#3D5A3E]">
          <ArrowLeft size={20} weight="bold" />
        </Link>
        <Package size={32} weight="duotone" className="text-[#3D5A3E]" />
        <h1 className="text-3xl font-bold text-[#3D5A3E]">Add Product</h1>
      </div>

      <p className="text-sm text-[#6B7C5E]">
      ...
      >
        <div>
          <label className="block text-sm font-medium text-[#2C3B2D] mb-1.5">Product Name *</label>
          <input
            type="text"
            required
            value={form.name}
        ...
        <div>
          <label className="block text-sm font-medium text-[#2C3B2D] mb-1.5">Category</label>
          <input
            type="text"
            value={form.category}
        ...
        <div className="grid grid-cols-2 gap-5">
          <div>
            <label className="block text-sm font-medium text-[#2C3B2D] mb-1.5">Price ($) *</label>
            <input
              type="number"
              step="0.01"
              min="0"
          ...
          <div>
            <label className="block text-sm font-medium text-[#2C3B2D] mb-1.5">Stock</label>
            <input
              type="number"
              min="0"
              value={form.stock}
        ...
        <div>
          <label className="block text-sm font-medium text-[#2C3B2D] mb-1.5">Image URLs (one per line)</label>
          <textarea
            rows={3}
            value={form.images}
            onChange={(e) => setForm({ ...form, images: e.target.value })}
            className="w-full px-4 py-2.5 border border-[#E8E3DA] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8AADA0] text-[#2C3B2D] text-sm resize-none font-mono"
